...
# --- TCMB MOTORU (SİZİN KODUNUZDAN ENTEGRE EDİLDİ) ---
...
def get_tcmb_data(api_key, start_date, end_date):
    ...
    try:
        ...
        # API Sorgusu için tarih aralığı (Geniş tutuyoruz)
        ...
        if row_end.empty: 
             row_end = raw_df.iloc[[-1]] # Bitiş yoksa en sonu al
...
if toplam != 100:
    ...
    # HATA ÇÖZÜMÜ: Sadece sayısal kolonlara format uyguluyoruz.
